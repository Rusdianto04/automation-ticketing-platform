                  ...
                  filtered.map((t, idx) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 max-w-[260px]">
                        <p className="font-semibold text-slate-800 truncate text-[13px]" title={t.title}>
                          {t.title}
                        </p>
                      </td>
                      <td className="px-4 py-3">
                      ...
                      <td className="px-4 py-3 max-w-[130px]">
                        <span className="text-slate-600 truncate block text-[12px]" title={t.requester}>
                          {t.requester || "—"}
                        </span>
                      </td>
      ...
      <ModalWrap title="Tiket Support Dibuat" onClose={onClose}>
        <div className="text-center py-6">
          ...
          <div className="flex gap-2 justify-center">
            <a href={`/admin/tickets/${ticketId}`} className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-[13px] font-semibold transition-colors">
              Lihat Detail
            </a>
